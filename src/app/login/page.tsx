          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <a
                  href="#"
                  className="inline-flex w-full justify-center rounded-xl bg-white px-4 py-2 text-sm font-medium text-slate-500 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 focus:outline-offset-0 transition-colors"
                >
              ...
              <div>
                ...
                >
                  ...
                  <Code className="h-5 w-5 text-slate-900" aria-hidden="true" />
                </a>
              </div>
            </div>
          </div>
